...
int main(int argc, char *argv[])
{
    ...
    static struct option longOptions[] = {
        ...
        {"initial-fuel",     required_argument, 0, 'f'},
        {"initial-height",   required_argument, 0, 'h'},
        {"initial-velocity", required_argument, 0, 'v'},
        {"max-thrust",       required_argument, 0, 't'},
        {0, 0, 0, 0}
    };

    while ((optionLetter = getopt_long(argc, argv, "t:f:g:h:v:", longOptions, NULL)) != -1) {
        switch (optionLetter) {
            case 't':
