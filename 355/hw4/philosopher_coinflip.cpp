...
class Philosopher
{
    ...
    public:
        ...
        void eat(int milliseconds = EATING_TIME)
        {
            ...
            bernoulli_distribution d(0.5); // coin flip: 50% chance
            ...
            while(true)
            {
                ...
                if (d(gen)) // coin flip to pick up
                {
                    if(syncro->pickUpChopstick(id))
                    {
                        break;
                    }
                }
            ...
            while (true)
            {
                if (d(gen)) // coin flip to put down
                {
